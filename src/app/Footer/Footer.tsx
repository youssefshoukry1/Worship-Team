      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 text-gray-400 gap-6">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left gap-1">
          <p className="font-light text-sm tracking-wide">
            ...
            <span className="font-semibold text-sky-400 hover:text-sky-300 transition-colors cursor-default">
              Youssef Shoukry
            </span>
          </p>
        ...
        <a
          ...
          className="group relative flex items-center gap-3 px-5 py-2.5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-sky-500/30 transition-all duration-300 overflow-hidden"
        >
          ...
          {/* Simple SVG icon inline to avoid import issues or reuse existing if available */}
          <svg
            className="w-5 h-5 text-green-400 group-hover:scale-110 transition-transform relative z-10"
            fill="currentColor"
            viewBox="0 0 24 24"
            aria-hidden="true"
          >
          ...
          <span className="text-sm font-medium text-gray-200 relative z-10 group-hover:text-white">
            Chat on WhatsApp
          </span>
        </a>
      </div>
