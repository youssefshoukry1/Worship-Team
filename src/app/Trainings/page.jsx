...
export default function Trainings() {
  ...
  return (
    <section className="min-h-screen bg-linear-to-br from-[#050510] via-[#0a0a1a] to-[#141432] text-white px-4 sm:px-6 py-16 relative overflow-hidden">
      ...
      <h1 className="text-3xl sm:text-5xl font-extrabold mb-14 text-center bg-linear-to-br from-sky-300 via-indigo-300 to-purple-400 text-transparent bg-clip-text drop-shadow-lg">
        🎶 Training Schedule
      </h1>
        ...
        <Portal>
          ...
          >
            ...
            >
              ...
              <h2 className="text-center text-2xl font-bold mb-6 bg-linear-to-br from-sky-300 to-purple-300 bg-clip-text text-transparent">
              ...
              <div className="flex flex-col gap-4">
                ...
                <button
                  ...
                  className={`mt-4 bg-linear-to-br from-sky-500 to-purple-500 py-3 rounded-xl text-white font-semibold transition shadow-lg shadow-purple-500/20
