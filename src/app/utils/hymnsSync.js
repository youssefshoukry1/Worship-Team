...
/**
 * Hydrates IndexedDB with packaged hymns.json if the cache is empty.
 * Runs on client side.
 */
export async function initLocalHymns() {
  ...
  try {
    ...
    console.log("[HymnsSync] Database is empty. Hydrating local cache from public/hymns.json...");
...
/**
 * Searches and filters hymns locally from the in-memory cache (falls back to localforage).
 */
